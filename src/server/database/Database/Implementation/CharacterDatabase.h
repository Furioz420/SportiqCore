...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_GET_CHARACTERS_ONLINE_ON_ACCOUNT,

    //Transmog
    CHAR_DEL_TRANSMOGRIFICATION_INFO,
    CHAR_INS_TRANSMOGRIFICATION_INFO,

    //Guild Leveling
    CHAR_UPD_GUILD_LEVEL,
    CHAR_UPD_GUILD_XP,
    CHAR_UPD_GUILD_TODAYXP,
    CHAR_UPD_GUILD_TODAY,
    CHAR_UPD_MEMBER_ILVL,

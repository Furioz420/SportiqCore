...
enum LoginDatabaseStatements : uint32
{
    ...
    */
    ...
    LOGIN_SEL_IS_PREMIUM,
    LOGIN_INS_ACCOUNT_PREMIUM,
    LOGIN_UPD_ACCOUNT_PREMIUM_NEW,
    LOGIN_REM_ACCOUNT_PREMIUM,
    LOGIN_UPD_STORE_BALANCE,
    LOGIN_UPD_STORE_VOTE,
    LOGIN_UPD_STORE_LOYALTY,
    LOGIN_SEL_SHOP_BONUS,
    LOGIN_SEL_SHOP_VOTE,
    LOGIN_SEL_SHOP_1,
    LOGIN_SEL_SHOP_2,
    LOGIN_SEL_SHOP_3,
    ...
    LOGIN_SEL_SHOP_6,
    LOGIN_SEL_SHOP_7,
    LOGIN_INSERT_STORE_BALANCE,
    LOGIN_INS_STORE_LOGS,
    LOGIN_SET_ACCOUNT_PREMIUM,
    LOGIN_DEL_ACCOUNT_PREMIUM,
    LOGIN_UPD_ACCOUNT_PREMIUM,
    LOGIN_GET_ACCOUNT_PREMIUM_STATUS_BY_ID,
    LOGIN_GET_ACCOUNT_PREMIUM_UNSETDATE_BY_ID,
